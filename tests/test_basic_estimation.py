...
class TestBasicEstimation:
    ...
    def test_parameter_recovery(self, small_binary_data):
        ...
        ideal_point_corr = np.corrcoef(results.ideal_points[:, 0], data["true_ideal_points"][:, 0])[
            0, 1
        ]
    ...
    def test_to_dataframe(self, small_binary_data):
        ...
        model = IdealPointEstimator(IdealPointConfig(n_dims=1, response_type=ResponseType.BINARY))
